...
**Overview:** In these two tutorials, we will be building on the R skills you learned in BIOL 1001. We will be focusing on manipulating and organizing data in tables, and learn a useful package called [dplyr](https://dplyr.tidyverse.org/) (pronounced "d-plier")
...
**HAND IN. [Q5]** Add a line of code to your R script, where you use the [`filter()`](https://ahurford.github.io/quant-guide-all-courses/handling-data.html#filtering-data) function to filter the data to only include plants with length longer than 2 cm.

**HAND IN. [Q6]** Add a line of code to your R script, where you use the [`filter()`](https://ahurford.github.io/quant-guide-all-courses/handling-data.html#filtering-data) function to show all entries with plants with length greater than 3 cm and width greater then 2 cm.
