...
**HAND IN. [Q5]** Add a line of code to your R script, where you use the [`filter()`](https://ahurford.github.io/quant-guide-all-courses/handling-data.html#filtering-data) function to filter the data to only include plants with length longer than 4 cm.
