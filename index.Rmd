...
In this section, we are interested in understanding the monthly variation in maximum temperature in [Bay D'Espoir](https://climate.weather.gc.ca/climate_data/daily_data_e.html?hlyRange=%7C&dlyRange=1965-03-01%7C1965-04-30&mlyRange=1965-01-01%7C1965-12-01&StationID=6565&Prov=NL&urlExtension=_e.html&searchType=stnProv&optLimit=yearRange&StartYear=1840&EndYear=2021&selRowPerPage=25&Line=16&Month=4&Day=29&lstProvince=NL&timeframe=2&Year=1965). These data are originally sourced from [Environment Canada](https://climate.weather.gc.ca/historical_data/search_historic_data_e.html).

You can learn about the data by reading the metadata file available on the course Brightspace.

In this section, we want you to 

- import the `max_temperature_data` from Brightspace 
