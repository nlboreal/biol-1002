...
In addition, this week's lab is taken from "Week 3: Data in Tables" of the online course ["Data Carpentry for Biologists"](https://datacarpentry.org/semester-biology/schedule/) by Dr. Ethan White. If you are not sure how to execute a particular command, you can refer to the "Lecture" material on [Dr. White's website](https://datacarpentry.org/semester-biology/lectures/R-data/)</u> and/or his [instructional videos](https://datacarpentry.org/semester-biology/lectures/R-data/) that go with the "Data in Tables" lesson. The example data in the lecture material and videos is different from the data you use in the exercise.
