...
**HAND IN. [Q6]** In your R Script, add a line of code where you use the `inner_join()` function to combine the sites data with the shrub dimensions, `shrub_dims` data, to produce:
